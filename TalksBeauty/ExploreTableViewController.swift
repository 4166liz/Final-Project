...
class ExploreTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let email = self.dataArray[indexPath.row]["email"] as? String
        if email == GlobalInstance.sharedInstance.user.email {
            return
        }
        
        let viewController = self.storyboard?.instantiateViewController(withIdentifier: "personalViewController") as! PeronsalViewController
